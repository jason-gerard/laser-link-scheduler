...
def multi_experiment_driver(experiment_names: list[str], scheduler_names: list[str], parameters: dict):
            ...
            for scheduler_name in scheduler_names:
                for parameter, parameter_values in parameters.items():
                    for parameter_value in parameter_values:
                        print(f"Starting execution of experiment: {experiment_name}, with scheduler: {scheduler_name}, with parameter: {parameter} = {parameter_value}")
                        experiment_driver(experiment_name, scheduler_name, reporter, parameter, parameter_value)
                        print("\n\n")
        except Exception as e:
