...
from time_expanded_graph import convert_contact_plan_to_time_expanded_graph, graph_fractionation
...
def scheduler_test_driver(experiment_name):
    ...
    split_time_expanded_graph = graph_fractionation(time_expanded_graph)
